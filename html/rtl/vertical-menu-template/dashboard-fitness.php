...
-->
    <?php
        $json = file_get_contents('http://45.55.66.194/api');
                        ...
                        <tbody>
                           <tr>
                               ...
                               <?php }elseif($obj->task1latest[$i]->task == 3){?>
                                ...
                                <td class="text-truncate">جهات خارجيه</td>
                              <?php }elseif($obj->task1latest[$i]->task == 6){?>
                        ...
                        <tbody>
                           <tr>
                               ...
                               <?php }elseif($obj->task2latest[$i]->task == 3){?>
                                ...
                                <td class="text-truncate">جهات خارجيه</td>
                               <?php }elseif($obj->task2latest[$i]->task == 6){?>
                                <td class="text-truncate">اخرى</td>
                                <?php } ?>
                        ...
                        <tbody>
                           <tr>
                               ...
                               <?php }elseif($obj->task3latest[$i]->task == 3){?>
                                ...
                                <td class="text-truncate">جهات خارجيه</td>
                               <?php }elseif($obj->task3latest[$i]->task == 6){?>
                                <td class="text-truncate">اخرى</td>
                                <?php } ?>
                        ...
                        <tbody>
                           <tr>
                               ...
                               <?php }elseif($obj->task4latest[$i]->task == 3){?>
                                ...
                                <td class="text-truncate">جهات خارجيه</td>
                               <?php }elseif($obj->task4latest[$i]->task == 6){?>
                                <td class="text-truncate">اخرى</td>
                                <?php } ?>
                        ...
                        <tbody>
                           <tr>
                               ...
                               <?php }elseif($obj->task5latest[$i]->task == 3){?>
                                ...
                                <td class="text-truncate">جهات خارجيه</td>
                               <?php }elseif($obj->task5latest[$i]->task == 6){?>
                                <td class="text-truncate">اخرى</td>
                                <?php } ?>
                        ...
                        <tbody>
                           <tr>
                               ...
                               <?php }elseif($obj->task6latest[$i]->task == 3){?>
                                ...
                                <td class="text-truncate">جهات خارجيه</td>
                               <?php }elseif($obj->task6latest[$i]->task == 6){?>
                                <td class="text-truncate">اخرى</td>
                                <?php } ?>
                        ...
                        <tbody>
                           <tr>
                               ...
                               <?php }elseif($obj->task7latest[$i]->task == 3){?>
                                ...
                                <td class="text-truncate">جهات خارجيه</td>
                               <?php }elseif($obj->task7latest[$i]->task == 6){?>
                                <td class="text-truncate">اخرى</td>
                                <?php } ?>
                        ...
                        <tbody>
                           <tr>
                               ...
                               <?php }elseif($obj->task8latest[$i]->task == 3){?>
                                ...
                                <td class="text-truncate">جهات خارجيه</td>
                               <?php }elseif($obj->task8latest[$i]->task == 6){?>
                                <td class="text-truncate">اخرى</td>
                                <?php } ?>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-12 border-right-blue-grey border-right-lighten-5">
                        <div class="my-1 text-xs-center">
                            ...
                            <div class="card-body" style="margin-top: -30px">
                                ...
                                <ul class="list-inline clearfix pt-1 mb-0">
                                    <li class="border-right-grey border-right-lighten-2 pr-2">
                                        <h2 class="grey darken-1 text-bold-400" id="ball1mapsaled">81%</h2>
                                        <span class="primary"><span class="ft-arrow-up"></span> المستلمة</span>
                                    </li>
                                    <li class="pl-2">
                                        <h2 class="grey darken-1 text-bold-400" id="ball1mapsalea">19%</h2>
                                        <span class="danger"><span class="ft-arrow-down"></span> غير مستلمة</span>
                                    </li>
                                </ul>
                            </div>
            ...
            <div class="card-body collapse in">
                <div id="daily-activity" class="table-responsive ">
                    <table class="table table-hover mb-0" style="font-family: tahoma">
                        ...
                        <tbody>
                           <tr>
                                <td class="text-truncate"><?php echo $obj->todo[$i]->id;?></td>
                                ...
                                <td class="text-truncate"><?php echo $obj->todo[$i]->agreement_file;?></td>
                                <td class="text-truncate"><?php echo $obj->todo[$i]->note;?></td>
                            </tr>
                        </tbody>
                        <?php }?>
                    </table>
                ...
                options: [
...

                    {
                        series: [{
                            ...
                            data: [
                               {value: <?php echo $obj->ball1bio;?> , name: 'المخططات'},
                                {value: 23, name: 'المنتجات'},
                                {value: 23, name: 'الوزارة'},
                                {value: 23, name: 'البنوك'},
                                {value: 23, name: 'أخرى'}
                            ]
                        }]
                    },
